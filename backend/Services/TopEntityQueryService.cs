...
{
    public class TopEntityQueryService
    {
        public async Task<List<TopResultDto>> GetTopEntitiesAsync(
            DbContext db,
            ...
            DateTime? to = null)
        {
            ...
            var totalSales = mapping[salesKey];
            ...
            if (string.IsNullOrEmpty(entityID.UserTable) || string.IsNullOrEmpty(entityID.UserField) ||
                ...
                string.IsNullOrEmpty(totalSales.UserTable) || string.IsNullOrEmpty(totalSales.UserField))
            {
            ...
            string joinSQL = $@"
                ...
                INNER JOIN {totalSales.UserTable} {aliasTotalSales} 
                    ON {aliasEntityID}.{entityID.UserField} = {aliasTotalSales}.{entityID.UserField}";
                ...
                from.HasValue && to.HasValue)
            {
                ...
                string transactionDateAlias = transactionDateMapping.UserTable switch
                {
                    ...
                    var t when t == totalSales.UserTable => aliasTotalSales,
                    _ => "tX" // fallback
                };
