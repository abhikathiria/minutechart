...
namespace Backend.Migrations
{
    ...
    [Migration("20251231062054_procurementsmodule")]
    partial class procurementsmodule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("minutechart.Models.ActiveSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.ActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.AdminProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.CatalogProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("QueryLastUpdated")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("minutechart.Models.CompanyInvoiceSetting", b =>
                {
                    ...
                    b.ToTable("CompanyInvoiceSettings");
                });
            ...
            modelBuilder.Entity("minutechart.Models.Complaint", b =>
                {
                    ...
                    b.Property<string>("AdminAttachmentUrls")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("UserAttachmentUrls")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("minutechart.Models.EmailSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.InvoiceColumnSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CompanyInvoiceSettingId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CompanyInvoiceSettingId");

                    b.ToTable("InvoiceColumnSettings");
                });
            ...
            modelBuilder.Entity("minutechart.Models.ModuleSuggestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.ProcurementsMain", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsMains");
                });

            modelBuilder.Entity("minutechart.Models.ProcurementsPurchaseOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsPurchaseOrders");
                });

            modelBuilder.Entity("minutechart.Models.ProcurementsPurchaseReturn", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsPurchaseReturns");
                });

            modelBuilder.Entity("minutechart.Models.ProcurementsQuote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsQuotes");
                });

            modelBuilder.Entity("minutechart.Models.ProcurementsReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsReports");
                });

            modelBuilder.Entity("minutechart.Models.ProcurementsRequirement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProcurementsRequirements");
                });

            modelBuilder.Entity("minutechart.Models.ProductionModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.SalesModule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.SubscriptionPlan", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("minutechart.Models.UserQuery", b =>
                {
                    ...
                    b.Property<string>("ApprovalIdColumn")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ApprovalUpdateQuery")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("minutechart.Models.AdminProfile", b =>
                {
                    b.HasOne("minutechart.Models.AppUser", "AppUser")
                        ...
                        .HasForeignKey("minutechart.Models.AdminProfile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("minutechart.Models.InvoiceColumnSetting", b =>
                {
                    b.HasOne("minutechart.Models.CompanyInvoiceSetting", "CompanyInvoiceSetting")
                        .WithMany("Columns")
                        .HasForeignKey("CompanyInvoiceSettingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CompanyInvoiceSetting");
                });
