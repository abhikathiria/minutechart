    ...
    public partial class productionmodule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductionModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductionModules_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductionModules_AppUserId_ComponentId",
                table: "ProductionModules",
