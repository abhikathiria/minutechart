...
{
    /// <inheritdoc />
    public partial class expensemodule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpenseModules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpenseModules_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseModules_AppUserId_ComponentId",
                table: "ExpenseModules",
