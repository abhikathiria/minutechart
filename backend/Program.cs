...
namespace minutechart
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            //     {
            //         policy.WithOrigins("http://localhost:3000", "http://172.20.10.2:3000", "http://172.20.10.2:5027")
            //               .AllowAnyHeader()
            //               .AllowAnyMethod()
            //               .AllowCredentials();
            //     });
            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowReactApp", policy =>
                {
                    policy.WithOrigins("https://minutechart.vercel.app", "http://192.168.1.19:3000")
                          .AllowAnyHeader()
                          .AllowAnyMethod()
                          .AllowCredentials();
                });
