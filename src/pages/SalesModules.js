  ...
  return (
    <div className="p-3 mt-3 rounded-lg bg-blue-50 border border-blue-200 text-xs text-blue-800">
      ...
      <pre className="mt-2 p-2 bg-white border rounded text-[11px] whitespace-pre-wrap">
        ...
        AND (@consigneeId IS NULL OR ConsigneeId = @consigneeId)
      </pre>
      <p className="mt-2">
...
export default function SalesModules() {
  ...
  async function handleTransferCheck() {
    ...
    try {
      const res = await api.post("/salesmodules/transfer-modules", {
        sourceUserId: userId,
      ...
      {transferModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-xl shadow-xl w-full max-w-lg">
            ...
            <h2 className="text-xl font-bold mb-4">Transfer Sales Modules</h2>
