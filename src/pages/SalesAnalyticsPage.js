  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={boxStyle}>
        ...
        >
          {isFullscreen ? (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0B3A66" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3"></path></svg>
          ) : (
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#0B3A66" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 3h6v6M9 21H3v-6M21 3l-7 7M3 21l7-7"></path></svg>
          )}
        </button>
        ...
        {isFullscreen && (
          <div 
            ...
            style={{
              ...
              marginTop: 10,
              flexShrink: 0,
              cursor: "pointer" // Shows hand cursor so user knows it closes
            }}
          >
            {title}
          </div>
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={boxStyle}>
        ...
        {/* --- FOOTER (Expand Button Left, Pagination Right) --- */}
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px", borderTop: "1px solid #eee", flexShrink: 0, background: "#fff" }}>
          ...
          {/* LEFT: Expand/Collapse Button (Icon Only) */}
          <button 
            onClick={() => setIsFullscreen(!isFullscreen)}
            style={{
              background: "#fff",
              border: "1px solid #ccc",
              borderRadius: "4px",
              padding: "6px", // Text nathi etle padding square kare
              cursor: "pointer",
              display: "flex", alignItems: "center", justifyContent: "center",
              color: "#0B3A66",
              boxShadow: "0 1px 2px rgba(0,0,0,0.05)"
            }}
            // Title attribute rakhyu che jethi mouse hover par text dekhay
          ...
          {pages > 1 ? (
            ...
            /* Spacer if no pagination needed */
            <div />
          )}
        </div>
