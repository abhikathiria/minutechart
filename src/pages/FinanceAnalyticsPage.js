  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={boxStyle}>
        ...
        {/* Legend */}
        <div style={{ marginBottom: 8, flexShrink: 0, paddingLeft: isFullscreen ? 0 : 30 }}> {/* Added padding so button doesn't cover legend in normal mode */}
          <CustomLineLegend
            payload={[
...
function BarChartWidget({ title, data }) {
  ...
  if (data.empty) {
    return <div style={{ height: widgetHeight, marginBottom: "0.75rem" }}><NoDataWidget title={title} /></div>;
  }
          ...
          >
            <thead>
              <tr>
                ...
                {/* --- RESTORED ORIGINAL COLUMNS LOGIC (Just "Δ %") --- */}
